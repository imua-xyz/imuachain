...
type SnapshotHelper struct {
	// last_changed_key indicates the key of the most recent change.
	// It is used to set the `last_changed_key` field in `VotingPowerSnapshot`.
	LastChangedKey string `protobuf:"bytes,1,opt,name=last_changed_key,json=lastChangedKey,proto3" json:"last_changed_key,omitempty"`
	...
	// has_slash is used to indicate whether there is a slash event has been executed before the epoch expires.
	// When a slash is executed, Dogfood can immediately update the voting power based on this flag.
	HasSlash bool `protobuf:"varint,3,opt,name=has_slash,json=hasSlash,proto3" json:"has_slash,omitempty"`
}
...
func (m *SnapshotHelper) GetLastChangedKey() string {
	if m != nil {
		return m.LastChangedKey
	}
	return ""
...
func (m *SnapshotHelper) GetHasSlash() bool {
	if m != nil {
		return m.HasSlash
	}
	return false
...
var fileDescriptor_b229d5663e4df167 = []byte{
	...
	,
}
...
func (m *SnapshotHelper) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field HasSlash", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
