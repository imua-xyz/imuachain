...
type ValidatorAccumulatedCommissions struct {
	...
	// for a validator kept as a running counter, can be withdrawn at any time.
	Commission *OperatorAccumulatedCommission `protobuf:"bytes,2,opt,name=commission,proto3" json:"commission,omitempty"`
}
...
func (m *ValidatorAccumulatedCommissions) GetCommission() *OperatorAccumulatedCommission {
	if m != nil {
		return m.Commission
	}
	return nil
...
type ValidatorCurrentRewardsList struct {
	...
	// period for a validator kept as a running counter and incremented
	// each block as long as the validator's tokens remain constant.
	CurrentRewards *OperatorCurrentRewards `protobuf:"bytes,2,opt,name=current_rewards,json=currentRewards,proto3" json:"current_rewards,omitempty"`
}
...
func (m *ValidatorCurrentRewardsList) GetCurrentRewards() *OperatorCurrentRewards {
	if m != nil {
...
type ValidatorOutstandingRewardsList struct {
	...
	// for a validator inexpensive to track, allows simple sanity checks.
	OutstandingRewards *OperatorOutstandingRewards `protobuf:"bytes,2,opt,name=outstanding_rewards,json=outstandingRewards,proto3" json:"outstanding_rewards,omitempty"`
}
...
func (m *ValidatorOutstandingRewardsList) GetOutstandingRewards() *OperatorOutstandingRewards {
	if m != nil {
...
var fileDescriptor_ee00a1c72b4ca316 = []byte{
	...
	,
}
...
func (m *ValidatorAccumulatedCommissions) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.Commission == nil {
				m.Commission = &OperatorAccumulatedCommission{}
			}
...
func (m *ValidatorCurrentRewardsList) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.CurrentRewards == nil {
				m.CurrentRewards = &OperatorCurrentRewards{}
			}
...
func (m *ValidatorOutstandingRewardsList) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.OutstandingRewards == nil {
				m.OutstandingRewards = &OperatorOutstandingRewards{}
			}
