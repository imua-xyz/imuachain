...
// source: imua/oracle/validators.proto
...
func init() {
	proto.RegisterType((*Validators)(nil), "imua.oracle.Validators")
	proto.RegisterType((*Validator)(nil), "imua.oracle.Validator")
}

func init() { proto.RegisterFile("imua/oracle/validators.proto", fileDescriptor_4264e9827808bf71) }
