...
import (
	...
	"github.com/ExocoreNetwork/exocore/x/oracle/migrations/cv2"
	cv2types "github.com/ExocoreNetwork/exocore/x/oracle/migrations/cv2/types"
...
func (am AppModule) RegisterServices(cfg module.Configurator) {
	...
	cfg.RegisterMigration(types.ModuleName, 1, func(ctx sdk.Context) error {
		cv2.MigrateV1ToV2(ctx, am.keeper)
		return nil
	})
}
