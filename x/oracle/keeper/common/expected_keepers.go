...
type KeeperOracle interface {
	...
	GrowRoundID(ctx sdk.Context, tokenID, nextRoundID uint64, accumulate bool) (price string, roundID uint64)
	AppendPriceTR(ctx sdk.Context, tokenID uint64, priceTR types.PriceTimeRound, accumulate bool) bool
	...
	GetMultipleAssetsPrices(ctx sdk.Context, assetIDs map[string]struct{}) (map[string]types.Price, error)
