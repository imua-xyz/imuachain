...
type GenesisState struct {
	...
	AvsInfos []AVSInfo `protobuf:"bytes,2,rep,name=avs_infos,json=avsInfos,proto3" json:"avs_infos"`
	// task_infos is the tasks issued by avs owner, indexed by
	// task address and task id
	// that are supported at chain genesis (or restart).
	TaskInfos []TaskInfo `protobuf:"bytes,3,rep,name=task_infos,json=taskInfos,proto3" json:"task_infos"`
	...
	BlsPubKeys []BlsPubKeyInfo `protobuf:"bytes,4,rep,name=bls_pub_keys,json=blsPubKeys,proto3" json:"bls_pub_keys"`
	...
	TaskResultInfos []TaskResultInfo `protobuf:"bytes,5,rep,name=task_result_infos,json=taskResultInfos,proto3" json:"task_result_infos"`
	...
	ChallengeInfos []ChallengeInfo `protobuf:"bytes,6,rep,name=challenge_infos,json=challengeInfos,proto3" json:"challenge_infos"`
	// task_nums is the task id, indexed
	// by the task address. The struct is the `TaskID`
	TaskNums []TaskID `protobuf:"bytes,7,rep,name=task_nums,json=taskNums,proto3" json:"task_nums"`
	// chain_id_infos is the dogfood chain id  informations, indexed
	// by the avs address. The struct is the `ChainIDInfo`
	ChainIdInfos []ChainIDInfo `protobuf:"bytes,8,rep,name=chain_id_infos,json=chainIdInfos,proto3" json:"chain_id_infos"`
	// pay_infos is the list of registered avs payment infos,
	// that are supported at chain genesis (or restart).
	PayInfos []AVSPaymentInfo `protobuf:"bytes,9,rep,name=pay_infos,json=payInfos,proto3" json:"pay_infos"`
}
...
func (m *GenesisState) GetPayInfos() []AVSPaymentInfo {
	if m != nil {
		return m.PayInfos
	}
	return nil
...
var fileDescriptor_9bf4bd04c417c12e = []byte{
	...
	,
}
...
func (m *GenesisState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.PayInfos) > 0 {
		for iNdEx := len(m.PayInfos) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.PayInfos[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PayInfos", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PayInfos = append(m.PayInfos, AVSPaymentInfo{})
			if err := m.PayInfos[len(m.PayInfos)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
