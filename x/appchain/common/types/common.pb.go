...
// source: imuachain/appchain/common/v1/common.proto
...
type SubscriberParams struct {
	...
	// provision of security from Imuachain to the appchain. Until a changeover
...
func (*SubscriberParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_308b2fd37a5188e7, []int{0}
}
...
// it being provisioned by Imuachain, as stored in the coordinator module.
...
func (*SubscriberGenesisState) Descriptor() ([]byte, []int) {
	return fileDescriptor_308b2fd37a5188e7, []int{1}
}
...
func (*CoordinatorInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_308b2fd37a5188e7, []int{2}
}
...
func init() {
	proto.RegisterType((*SubscriberParams)(nil), "imuachain.appchain.common.v1.SubscriberParams")
	proto.RegisterType((*SubscriberGenesisState)(nil), "imuachain.appchain.common.v1.SubscriberGenesisState")
	proto.RegisterType((*CoordinatorInfo)(nil), "imuachain.appchain.common.v1.CoordinatorInfo")
}

func init() {
	proto.RegisterFile("imuachain/appchain/common/v1/common.proto", fileDescriptor_308b2fd37a5188e7)
}

var fileDescriptor_308b2fd37a5188e7 = []byte{
	// 816 bytes of a gzipped FileDescriptorProto
	,
}
