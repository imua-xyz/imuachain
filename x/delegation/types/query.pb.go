...
// QueryDelegatedAmountRequest is the request to obtain the delegated amount for the specified staker, asset
// and operator.
...
func (*QueryDelegatedAmountRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_aab345e1cf20490c, []int{18}
}
...
func (m *QueryDelegatedAmountRequest) GetStakerId() string {
	if m != nil {
		return m.StakerId
	}
	return ""
...
func (m *QueryDelegatedAmountRequest) GetAssetId() string {
	if m != nil {
		return m.AssetId
	}
	return ""
...
func (m *QueryDelegatedAmountRequest) GetOperator() string {
	if m != nil {
		return m.Operator
	}
	return ""
...
// QueryDelegatedAmountResponse is the response to QueryDelegatedAmountRequest
type QueryDelegatedAmountResponse struct {
	// amount is the returned delegated amount
...
func (*QueryDelegatedAmountResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_aab345e1cf20490c, []int{19}
}
...
func init() {
	...
	proto.RegisterType((*QueryDelegatedAmountRequest)(nil), "exocore.delegation.v1.QueryDelegatedAmountRequest")
	proto.RegisterType((*QueryDelegatedAmountResponse)(nil), "exocore.delegation.v1.QueryDelegatedAmountResponse")
}
...
var fileDescriptor_aab345e1cf20490c = []byte{
	...
	,
}
...
type QueryClient interface {
	...
	// QueryDelegatedAmount queries the delegated amount for the specified staker, asset and operator.
	QueryDelegatedAmount(ctx context.Context, in *QueryDelegatedAmountRequest, opts ...grpc.CallOption) (*QueryDelegatedAmountResponse, error)
}
...
func (c *queryClient) QueryDelegatedAmount(ctx context.Context, in *QueryDelegatedAmountRequest, opts ...grpc.CallOption) (*QueryDelegatedAmountResponse, error) {
	out := new(QueryDelegatedAmountResponse)
	err := c.cc.Invoke(ctx, "/exocore.delegation.v1.Query/QueryDelegatedAmount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QueryServer interface {
	...
	// QueryDelegatedAmount queries the delegated amount for the specified staker, asset and operator.
	QueryDelegatedAmount(context.Context, *QueryDelegatedAmountRequest) (*QueryDelegatedAmountResponse, error)
}
...
func (*UnimplementedQueryServer) QueryDelegatedAmount(ctx context.Context, req *QueryDelegatedAmountRequest) (*QueryDelegatedAmountResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method QueryDelegatedAmount not implemented")
}
...
func _Query_QueryDelegatedAmount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryDelegatedAmountRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).QueryDelegatedAmount(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/exocore.delegation.v1.Query/QueryDelegatedAmount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).QueryDelegatedAmount(ctx, req.(*QueryDelegatedAmountRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "QueryDelegatedAmount",
			Handler:    _Query_QueryDelegatedAmount_Handler,
		},
	},
