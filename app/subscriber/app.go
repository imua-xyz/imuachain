...
import (
	...
	subscriberkeeper "github.com/ExocoreNetwork/exocore/x/appchain/subscriber/keeper"
	subscribertypes "github.com/ExocoreNetwork/exocore/x/appchain/subscriber/types"
)

const (
	AccountAddressPrefix = "sub"
	Name                 = "subscriber"
)
...
type App struct {
	*baseapp.BaseApp
	...
	// pointer so that SetCapability can be called correctly
	...
	ScopedSubscriberKeeper capabilitykeeper.ScopedKeeper
...
func New(
	...
	scopedSubscriberKeeper := app.CapabilityKeeper.ScopeToModule(subscribertypes.ModuleName)
	...
	delete(
		bankBlockedAddrs,
		authtypes.NewModuleAddress(subscribertypes.SubscriberToSendToCoordinatorName).String(),
	)
	...
	app.SlashingKeeper = slashingkeeper.NewKeeper(
		...
		&app.SubscriberKeeper, // satisfies interface
		authtypes.NewModuleAddress(govtypes.ModuleName).String(),
	)
	...
	*/
	...
	// create fake subscriber keeper to satisfy ibc keeper
	app.SubscriberKeeper = subscriberkeeper.NewEmptyKeeper(
		appCodec, keys[subscribertypes.StoreKey],
	)
	app.IBCKeeper = ibckeeper.NewKeeper(
		appCodec,
		keys[ibcexported.StoreKey],
		app.GetSubspace(ibcexported.ModuleName),
		app.SubscriberKeeper,
		app.UpgradeKeeper,
		scopedIBCKeeper,
	)

	// actual subscriber keeper
	app.SubscriberKeeper = subscriberkeeper.NewKeeper(
		appCodec,
		keys[subscribertypes.StoreKey],
		app.AccountKeeper,
		app.BankKeeper,
		scopedSubscriberKeeper,
		&app.IBCKeeper.PortKeeper,
		app.IBCKeeper.ClientKeeper,
		app.IBCKeeper.ConnectionKeeper,
		app.IBCKeeper.ChannelKeeper,
		app.IBCKeeper,
		// this MUST be a pointer so that assignments within this file
		// flow through to the keeper
		&app.TransferKeeper,
		authtypes.FeeCollectorName,
	)
	// slashing hooks
	app.SubscriberKeeper = *app.SubscriberKeeper.SetHooks(app.SlashingKeeper.Hooks())
	...
	ibcRouter.AddRoute(subscribertypes.ModuleName, subscriberIbcModule)
	...
	app.ScopedSubscriberKeeper = scopedSubscriberKeeper
